  ...
  <div class="score">
    ...
    <scroll ref="scroll" class="score-content">
      <div class="score-wrapper" v-if="score">
        ...
        <!--        <div id="scoreChart">-->
        <!--          <div id="scorePie" style="width: 100%; height: 400px; margin-top: 20px"></div>-->
...
export default {
  ...
  methods: {
    ...
    getScore () {
      DOMAIN(domain => {
        let ajaxUrl = `${domain}/security/wjdc/scale.do?action=getQuestionNaireScore`
    ...
    drawLine () {
      ...
      let tooMuch = true
      if (this.score.weidu.length > 10) tooMuch = false
      // 绘制饼图
      scorePie.setOption({
        title: {
          text: '量表的总分以及各维度分数',
